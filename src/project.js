...
import { SiChakraui, SiReact, SiJavascript } from "react-icons/si";
...
const Projects = () => {
  const projects = [
      ...
      techStack: [
        {
          id: 1,
          skill: "HTML5",
          img: <AiFillHtml5 size="20px" color="rgb(233,89,35)" />
        },
        { id: 2, skill: "CSS3", img: <IoLogoCss3 size="20px" color="blue" /> },
        {
          id: 3,
          skill: "JavaScript",
          img: <SiJavascript size="20px" color="orange" />
        },
        {
          id: 4,
          skill: "React JS",
          img: <SiReact size="20px" color="skyblue" />
        },
        {
          id: 5,
          skill: "Node JS",
          img: <FaNodeJs size="20px" color="rgb(78,201,196)" />
        },
        {
          id: 6,
          skill: "Mongo DB",
          img: <DiMongodb size="20px" color="rgb(78,201,196)" />
        }
      ],
      description:
      ...
      techStack: [
        {
          id: 1,
          skill: "HTML",
          img: <AiFillHtml5 size="20px" color="#e2660f" />
        },
        {
          id: 2,
          skill: "Javascript",
        ...
        },
        {
          id: 3,
          skill: "Css",
          img: <IoLogoCss3 size="20px" color="rgb(78,201,196)" />
        }
      ],
      description:
    ...
    //   {id:3,skill:'Css',img:<IoLogoCss3 size='20px' color='rgb(78,201,196)' />},
  ...
  return (
    ...
    >
      ...
      <Container maxW="100%" gap="20px" margin="auto" p="0px" marginTop="50px">
